    ...
    <div className="carousel-container">
      ...
      >
        ...
        <SwiperSlide>
          <div className="card">
            <h2>Mi Amort</h2>
            <img src="images/img1.png" alt="Recuerdo especial" className="card-img" />
            <p>
        ...
        <SwiperSlide>
          <div className="card">
            ...
            <img src="images/img3.jpg" alt="Recuerdo juntos" className="card-img" />
            <p>
        ...
        <SwiperSlide>
          <div className="card">
            ...
            <img src="images/img2.png" alt="Orgullo de ti" className="card-img" />
            <p>
